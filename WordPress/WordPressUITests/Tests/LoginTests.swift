...
class LoginTests: XCTestCase {
    ...
    func testEmailPasswordLoginLogout() {
        let welcomeScreen = WelcomeScreen().selectLogin()
            ...
            .verifyEpilogueDisplays(username: WPUITestCredentials.testWPcomUsername, siteUrl: WPUITestCredentials.testWPcomSiteDisplayName)
    ...
    func testWpcomUsernamePasswordLogin() {
        _ = WelcomeScreen().selectLogin()
            ...
            .proceedWith(username: WPUITestCredentials.testWPcomSiteDisplayName, password: WPUITestCredentials.testWPcomPassword)
            .verifyEpilogueDisplays(username: WPUITestCredentials.testWPcomUsername, siteUrl: WPUITestCredentials.testWPcomSiteDisplayName)
            .continueWithSelectedSite()
            .dismissNotificationAlertIfNeeded()
